    ...
    <div class="card">
        <div class="card-body">
          ...
          <div class="alert alert-secondary text-white" role="alert">
              <strong>{{ __('You are editing the :langNative version', ['langNative' => localization()->getSupportedLocales()[app()->getLocale()]->native()]) }} (<a href="{{ localization()->getLocalizedURL(app()->getLocale(), route('home') . '/' . $slug, [], true) }}" class="text-light">{{ __('View page') }}</a>).</strong>
          </div>
