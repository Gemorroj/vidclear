<div class="d-flex" wire:ignore.self>
	...
	<div class="col-sm-4 col-8 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3" wire:ignore>
		<div class="nav-wrapper position-relative end-0">

			<ul class="nav nav-pills nav-fill p-1" role="tablist">

				<li class="nav-item">
					<a class="nav-link mb-0 px-0 py-1 active" href="javascript:;" id="overview-tab" data-bs-toggle="tab" data-bs-target="#overview">
				...
				<li class="nav-item">
					<a class="nav-link mb-0 px-0 py-1" href="javascript:;" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile">
						...
						<span class="ms-1">{{ __('Update Profile') }}</span>
					</a>
				</li>

				<li class="nav-item">
					<a class="nav-link mb-0 px-0 py-1" href="javascript:;" id="password-tab" data-bs-toggle="tab" data-bs-target="#password">
						...
						<span class="ms-1">{{ __('Change Password') }}</span>
					</a>
				</li>
